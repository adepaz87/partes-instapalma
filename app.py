...
def webhook():
    ...
    _comando_ge = (_msg_inicio_ge == 'mantenimiento ge')
    if not (estado and str(estado.get('paso', '')).startswith('herr_')) and _comando_ge:
    ...
    # Detectar arranque mantenimiento GE
    if False and any(p in normalizar(incoming_msg) for p in MENSAJES_MANTENIMIENTO_GE):
...
<header>
  ...
  <nav class="nav">
    ...
    <a href="https://site.zapia.com/mfhkvqzy" target="_blank">🛠️ OT TBSA</a>
    <a href="https://drive.google.com/file/d/12U4pynCU_Ob7DxrNA5qKtpxxVFdtYDb5/view?usp=drivesdk" target="_blank">🦺 PRL</a>
    <a href="https://site.zapia.com/15h2rnqs" target="_blank">📅 Agenda</a>
  </nav>
</header>
...
def panel_vehiculos():
    ...
    <div style='padding:8px 30px 20px'><a href='/partes' class='back'>← Partes</a> &nbsp; <a href='/' class='back'>🏠 Dashboard</a></div>
    </body></html>"""
    from flask import Response
...
def editar_saldo(op=None):
    ...
    <div style='padding:8px 30px 20px'><a href='/vacaciones' class='back'>← Vacaciones</a> &nbsp; <a href='/' class='back'>🏠 Dashboard</a></div>
    </body></html>"""
...
def editar_material(mid=None):
    ...
    <div style='padding:8px 30px 20px'><a href='/almacen' class='back'>← Almacén</a> &nbsp; <a href='/' class='back'>🏠 Dashboard</a></div>
    </body></html>"""
...
def web_herramienta_form(mid=None):
    ...
    <div style='padding:8px 30px 20px'><a href='/herramienta' class='back'>← Herramienta</a> &nbsp; <a href='/' class='back'>🏠 Dashboard</a></div></body></html>"""
...
def web_editar_obra(oid):
    ...
    </form><p style='text-align:center;margin-top:16px'><a href='/herramienta'>← Herramienta</a> &nbsp; <a href='/'>🏠 Dashboard</a></p></div>
    </body></html>""" 
